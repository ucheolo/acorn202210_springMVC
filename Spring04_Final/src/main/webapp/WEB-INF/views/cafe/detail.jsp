...
<body>
	<div class="container">
						...
						<c:otherwise>
							...
							<dl>
								<dt>
									...
									<span>${tmp.regdate }</span> <a data-num="${tmp.num }"
							...
							<c:if test="${tmp.writer eq id }">
								<form id="updateForm${tmp.num }"
									class="comment-form update-form" action="comment_update.do"
									method="post">
		...
		<!-- 원글에 댓글을 작성할 폼 -->
		<form class="comment-form insert-form" action="comment_insert.do"
			method="post">
